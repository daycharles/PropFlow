...
triggers it) is still deferred to the M5 event wiring. PF-4.10 landed the Tidewater demo seed;
PF-4.08/PF-4.09 (web) and PF-4.11 (e2e) are the remaining work.
...
| PF-4.10 | ✅ Seed: Tidewater Residential Management — deterministic `TidewaterSeed` (fixed RNG): 3 properties, 10 buildings, ~80 spaces, ~70 current residents with mixed consent, 6 vendors, 5 employees, 6 categories, ~70 assets, 100 work items across every status/priority, ~20 pest-control, a third of open items overdue. The isolation tenant keeps the minimal 12-item seed. | infra | M | PF-4.01, PF-3.22 |
