...
/// <summary>All-or-nothing bulk assignment result: <paramref name="Changed"/> plus <paramref name="Unchanged"/> equals <paramref name="Total"/> whenever the batch committed.</summary>
...
public interface IWorkOperations
{
    ...
    Task<BulkAssignmentSummary> BulkAssignVendorAsync(IReadOnlyList<BulkVendorAssignment> assignments, Guid vendorId, Guid actorId, CancellationToken cancellationToken);
}
