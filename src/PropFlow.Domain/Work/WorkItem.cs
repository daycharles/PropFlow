...
// The two automation triggers. Raised by the application layer *after* the work change commits;
// they carry only the identity of what happened — the evaluator re-reads the committed work item.
