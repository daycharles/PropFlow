...
namespace PropFlow.Infrastructure.Persistence.Migrations.Operations
{
    ...
    [Migration("20260913010735_FS_S18Reporting")]
    partial class FS_S18Reporting
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PropFlow.Domain.Configuration.NotificationPreference", b =>
                {
                    b.Property<Guid>("OrganizationId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OrganizationId", "UserId", "EventType")
                        .IsUnique();

                    b.ToTable("NotificationPreferences", "operations");
                });
            ...
            modelBuilder.Entity("PropFlow.Domain.Reporting.ReportDelivery", b =>
                {
                    b.Property<Guid>("OrganizationId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OrganizationId", "ScheduleId", "DeliveredAt");

                    b.ToTable("ReportDeliveries", "operations");
                });

            modelBuilder.Entity("PropFlow.Domain.Reporting.ReportSchedule", b =>
                {
                    b.Property<Guid>("OrganizationId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OrganizationId", "IsActive", "NextRunAt");

                    b.ToTable("ReportSchedules", "operations");
                });
            ...
            modelBuilder.Entity("PropFlow.Domain.Reporting.ReportDelivery", b =>
                {
                    b.HasOne("PropFlow.Domain.Reporting.ReportSchedule", null)
                        .WithMany()
                        .HasForeignKey("OrganizationId", "ScheduleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
